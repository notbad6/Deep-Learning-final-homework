...
if __name__ == "__main__":
    jsonfilePath = "E:\code\data\json"  # 要转换的json文件所在目录
    resultDirPath = "E:\code\data\labels"  # 要生成的txt文件夹
    labelme2yolov2Seg(jsonfilePath=jsonfilePath, resultDirPath=resultDirPath, classList=["bubble"])
